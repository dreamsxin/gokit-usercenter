...
import (
	...
	http1 "github.com/dreamsxin/gokitusercenter/pkg/http"
...
var fs = flag.NewFlagSet("gokitusercenter", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("gokitusercenter", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
